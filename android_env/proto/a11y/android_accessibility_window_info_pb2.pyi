...
class AndroidAccessibilityWindowInfo(_message.Message):
    ...
    class WindowType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        TYPE_MAGNIFICATION_OVERLAY: _ClassVar[AndroidAccessibilityWindowInfo.WindowType]
        TYPE_WINDOW_CONTROL: _ClassVar[AndroidAccessibilityWindowInfo.WindowType]
    ...
    TYPE_MAGNIFICATION_OVERLAY: AndroidAccessibilityWindowInfo.WindowType
    TYPE_WINDOW_CONTROL: AndroidAccessibilityWindowInfo.WindowType
